...
export default function CartIcon() {
  ...
  return (
    <div className="relative p-2 bg-white/5 border border-white/10 rounded-full px-5 flex items-center gap-2 cursor-pointer hover:bg-white/10 transition-all">
